...
namespace SwedbankPay.Checkout.Episerver.OrderManagement.Events
{
    ...
    public class OrderCancelledEventHandler
    {
        ...
        public void Handle(OrderCancelledEvent ev)
        {
            ...
            var previousPayment = _orderForm.Payments.FirstOrDefault(x => x.IsSwedbankPayPayment());
        ...
        {
            return _orderForm.Payments.Any(p => p.TransactionType == TransactionType.Void.ToString() || p.TransactionType == TransactionType.Capture.ToString());
        }
    }
}
