<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConfigurePayment.ascx.cs" Inherits="SwedbankPay.Checkout.Episerver.CommerceManager.Apps.Order.Payments.Plugins.SwedbankPayCheckout.ConfigurePayment" %>
